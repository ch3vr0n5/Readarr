    ...
    public class InitialSetup : NzbDroneMigrationBase
    {
        protected override void MainDbUpgrade()
        {
            ...
            Create.TableForModel("Book")
                ...
                .WithColumn("PageCount").AsInt32()
                .WithColumn("Rating").AsDouble()
                .WithColumn("RatingCount").AsInt32()
                .WithColumn("Publisher").AsString()
                .WithColumn("PublishedDate").AsString().Nullable()
                .WithColumn("ISBN10").AsString().Nullable()
                .WithColumn("ISBN13").AsString().Nullable()
                .WithColumn("RemoteImageSmall").AsString()
                .WithColumn("RemoteImage").AsString()
                .WithColumn("Monitored").AsBoolean()
